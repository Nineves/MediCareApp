...
import com.example.medicare.alarm.ReminderActivity;
import com.example.medicare.alarm.ReminderFragment;
import com.example.medicare.data.source.MedicineAlarm;
import com.example.medicare.data.source.Pills;
import com.example.medicare.views.DayViewCheckBox;
import com.example.medicare.views.RobotoBoldTextView;
...
public class AddMedicineFragment extends Fragment implements AddMedicineContract.View {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        fab.setImageResource(R.drawable.ic_done1);
